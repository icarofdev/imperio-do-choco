        ...
        return `
            <div class="rodape-site__container">
                ...
                <div class="rodape-site__grid">
                    ...
                    <section class="rodape-site__coluna rodape-site__coluna--contato"><h3>Contato</h3><p>Segunda a sexta, das 7h às 12h</p><p>(11) 4002-8922</p><p>contato@velledulcis.com</p><p>São Paulo, Brasil</p><div class="rodape-site__social"><a href="https://www.instagram.com/velledulcis/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" title="Instagram Velle Dulcis"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3.5" y="3.5" width="17" height="17" rx="5"></rect><circle cx="12" cy="12" r="4"></circle><circle cx="17.2" cy="6.8" r="1"></circle></svg></a><span class="rodape-site__pix" aria-label="Pix" title="Pix"><img src="../assets/images/ui/pix.png" alt="Pix" width="1024" height="1024" loading="lazy"></span></div></section>
                </div>
                <div class="rodape-site__base"><p>&copy; Velle Dulcis 2026</p><span class="rodape-site__moeda">BRL</span></div>
            </div>
        `;
    }
    ...
    function commerceMarkup(options = {}) {
        ...
        return `
            <div id="overlay-pesquisa" class="overlay-pesquisa oculto">
                <div class="overlay-pesquisa__cabecalho"><button id="fechar-pesquisa" class="overlay-pesquisa__fechar" type="button" aria-label="Fechar pesquisa">&times;</button></div>
                <div class="overlay-pesquisa__conteudo"><h2>Pesquisar chocolates</h2><div class="pesquisa-wrapper"><div class="pesquisa-box"><div class="pesquisa-campo"><span class="pesquisa-icone" aria-hidden="true"><svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="7.5"></circle><path d="M16.5 16.5L21 21"></path></svg></span><input type="text" id="barra-pesquisa" placeholder="Buscar chocolate..."><button id="btn-limpar-pesquisa" class="btn-icone oculto" type="button" aria-label="Limpar pesquisa">&times;</button></div><div class="pesquisa-atalhos" aria-label="Atalhos de busca"><span class="pesquisa-atalhos__rotulo">Atalhos rápidos</span><div id="lista-atalhos-pesquisa" class="pesquisa-atalhos__lista"></div></div><div id="painel-pesquisa" class="painel-pesquisa"><div class="painel-pesquisa__bloco"><h3>Sugestões</h3><div id="lista-sugestoes" class="lista-sugestoes"></div></div><div class="painel-pesquisa__bloco"><div class="painel-pesquisa__topo"><button id="btn-ver-todos" class="btn-ver-todos" type="button">Veja todos os produtos</button></div><div id="lista-resultados-pesquisa" class="lista-resultados-pesquisa"></div></div></div></div></div></div>
            </div>
            <div id="overlay-carrinho" class="overlay-carrinho" aria-hidden="true"></div>
            <aside id="carrinho-lateral"><div class="carrinho-topo"><h3>Minha sacola</h3><button id="fechar-carrinho" class="carrinho-fechar" type="button" aria-label="Fechar carrinho">&times;</button></div><div class="carrinho-corpo"><ul id="lista-carrinho"></ul></div><div class="carrinho-resumo"><div class="carrinho-resumo__linha"><span>Subtotal</span><strong id="subtotal-preco">R$ 0,00</strong></div><div class="carrinho-resumo__linha carrinho-resumo__linha--total"><span>Total</span><strong id="total-preco">R$ 0,00</strong></div><button id="finalizar">Finalizar pedido</button></div></aside>
